...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-07 23:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0906567a-732d-4538-92ff-ed03fdc87fcb.git
$ cd 0906567a-732d-4538-92ff-ed03fdc87fcb
```
